...
- Both search screens track `cursorPos` (grapheme cluster index) for mid-text editing; `renderSearchInput()` in `terminal_ui.dart` renders ANSI inverse block cursor — use it for any new search input UI
