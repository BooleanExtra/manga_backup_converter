...
class TachimangaBackupMapper extends ClassMapperBase<TachimangaBackup> {
  ...
  static const Field<TachimangaBackup, TachimangaBackupMeta> _f$meta = Field('meta', _$meta);
  static TachimangaBackupDb _$db(TachimangaBackup v) => v.db;
  static const Field<TachimangaBackup, TachimangaBackupDb> _f$db = Field('db', _$db);
  static Map<String, Object?>? _$pref(TachimangaBackup v) => v.pref;
  static const Field<TachimangaBackup, Map<String, Object?>> _f$pref = Field('pref', _$pref, opt: true);
  static Pbxproj? _$prefAll(TachimangaBackup v) => v.prefAll;
  static const Field<TachimangaBackup, Pbxproj> _f$prefAll = Field('prefAll', _$prefAll, opt: true);
  static Map<String, Map<String, Object?>>? _$prefs(TachimangaBackup v) => v.prefs;
  static const Field<TachimangaBackup, Map<String, Map<String, Object?>>> _f$prefs = Field('prefs', _$prefs, opt: true);
  static Map<String, Uint8List>? _$extensions(TachimangaBackup v) => v.extensions;
  static const Field<TachimangaBackup, Map<String, Uint8List>> _f$extensions = Field(
    'extensions',
    _$extensions,
    opt: true,
  );
  static String? _$name(TachimangaBackup v) => v.name;
  static const Field<TachimangaBackup, String> _f$name = Field('name', _$name, opt: true);
...
mixin TachimangaBackupMappable {
  String toJson() {
    return TachimangaBackupMapper.ensureInitialized().encodeJson<TachimangaBackup>(this as TachimangaBackup);
  }

  Map<String, dynamic> toMap() {
    return TachimangaBackupMapper.ensureInitialized().encodeMap<TachimangaBackup>(this as TachimangaBackup);
  }

  TachimangaBackupCopyWith<TachimangaBackup, TachimangaBackup, TachimangaBackup> get copyWith =>
      _TachimangaBackupCopyWithImpl(this as TachimangaBackup, $identity, $identity);
  @override
  String toString() {
    return TachimangaBackupMapper.ensureInitialized().stringifyValue(this as TachimangaBackup);
  }

  @override
  bool operator ==(Object other) {
    return TachimangaBackupMapper.ensureInitialized().equalsValue(this as TachimangaBackup, other);
  }

  @override
  int get hashCode {
    return TachimangaBackupMapper.ensureInitialized().hashValue(this as TachimangaBackup);
  }
}

extension TachimangaBackupValueCopy<$R, $Out> on ObjectCopyWith<$R, TachimangaBackup, $Out> {
  TachimangaBackupCopyWith<$R, TachimangaBackup, $Out> get $asTachimangaBackup =>
...
abstract class TachimangaBackupCopyWith<$R, $In extends TachimangaBackup, $Out>
  ...
  TachimangaBackupMetaCopyWith<$R, TachimangaBackupMeta, TachimangaBackupMeta> get meta;
  TachimangaBackupDbCopyWith<$R, TachimangaBackupDb, TachimangaBackupDb> get db;
  MapCopyWith<$R, String, Object?, ObjectCopyWith<$R, Object?, Object?>?>? get pref;
  MapCopyWith<$R, String, Map<String, Object?>, ObjectCopyWith<$R, Map<String, Object?>, Map<String, Object?>>>?
  get prefs;
  MapCopyWith<$R, String, Uint8List, ObjectCopyWith<$R, Uint8List, Uint8List>>? get extensions;
  $R call({
  ...
  TachimangaBackupCopyWith<$R2, $In, $Out2> $chain<$R2, $Out2>(Then<$Out2, $R2> t);
}

class _TachimangaBackupCopyWithImpl<$R, $Out> extends ClassCopyWithBase<$R, TachimangaBackup, $Out>
  ...
  @override
  late final ClassMapperBase<TachimangaBackup> $mapper = TachimangaBackupMapper.ensureInitialized();
  @override
  TachimangaBackupMetaCopyWith<$R, TachimangaBackupMeta, TachimangaBackupMeta> get meta =>
  ...
  MapCopyWith<$R, String, Object?, ObjectCopyWith<$R, Object?, Object?>?>? get pref =>
      $value.pref != null
          ? MapCopyWith($value.pref!, (v, t) => ObjectCopyWith(v, $identity, t), (v) => call(pref: v))
          : null;
  @override
  MapCopyWith<$R, String, Map<String, Object?>, ObjectCopyWith<$R, Map<String, Object?>, Map<String, Object?>>>?
  get prefs =>
      $value.prefs != null
          ? MapCopyWith($value.prefs!, (v, t) => ObjectCopyWith(v, $identity, t), (v) => call(prefs: v))
          : null;
  @override
  MapCopyWith<$R, String, Uint8List, ObjectCopyWith<$R, Uint8List, Uint8List>>? get extensions =>
  ...
  @override
  TachimangaBackupCopyWith<$R2, TachimangaBackup, $Out2> $chain<$R2, $Out2>(Then<$Out2, $R2> t) =>
