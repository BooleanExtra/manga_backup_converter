...
mixin PaperbackBackupChapterMappable {
  ...
  >
  get copyWith =>
      _PaperbackBackupChapterCopyWithImpl<
        PaperbackBackupChapter,
        PaperbackBackupChapter
...
extension PaperbackBackupChapterValueCopy<$R, $Out>
  ...
  get $asPaperbackBackupChapter => $base.as(
    (v, t, t2) => _PaperbackBackupChapterCopyWithImpl<$R, $Out>(v, t, t2),
  );
}
...
class _PaperbackBackupChapterCopyWithImpl<$R, $Out>
  ...
  $chain<$R2, $Out2>(Then<$Out2, $R2> t) =>
      _PaperbackBackupChapterCopyWithImpl<$R2, $Out2>($value, $cast, t);
}
