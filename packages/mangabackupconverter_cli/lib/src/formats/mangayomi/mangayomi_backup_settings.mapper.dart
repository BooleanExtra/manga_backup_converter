...
class _ChapterFilterUnreadCopyWithImpl<$R, $Out>
  ...
  @override
  ChapterFilterUnreadCopyWith<$R2, ChapterFilterUnread, $Out2> $chain<
    $R2,
    $Out2
  >(Then<$Out2, $R2> t) => _ChapterFilterUnreadCopyWithImpl($value, $cast, t);
}
