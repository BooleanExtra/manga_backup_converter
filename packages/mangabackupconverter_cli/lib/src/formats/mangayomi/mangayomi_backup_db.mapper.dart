...
class MangayomiBackupDbMapper extends ClassMapperBase<MangayomiBackupDb> {
  ...
  static const Field<MangayomiBackupDb,
          List<MangayomiBackupExtensionPreferences>> _f$extensionPreferences =
      Field('extensionPreferences', _$extensionPreferences,
          key: r'extension_preferences', opt: true);
  ...
  static const Field<MangayomiBackupDb, List<MangayomiBackupTrackPreferences>>
      _f$trackPreferences =
      Field('trackPreferences', _$trackPreferences, opt: true);
...
abstract class MangayomiBackupDbCopyWith<$R, $In extends MangayomiBackupDb,
  ...
  ListCopyWith<
      ...
      MangayomiBackupMangaCopyWith<$R, MangayomiBackupManga,
          MangayomiBackupManga>>? get manga;
  ListCopyWith<
      $R,
      MangayomiBackupCategory,
      MangayomiBackupCategoryCopyWith<$R, MangayomiBackupCategory,
          MangayomiBackupCategory>>? get categories;
  ListCopyWith<
      $R,
      MangayomiBackupChapter,
      MangayomiBackupChapterCopyWith<$R, MangayomiBackupChapter,
          MangayomiBackupChapter>>? get chapters;
  ListCopyWith<
      $R,
      MangayomiBackupDownload,
      MangayomiBackupDownloadCopyWith<$R, MangayomiBackupDownload,
          MangayomiBackupDownload>>? get downloads;
  ListCopyWith<
      $R,
      MangayomiBackupTrack,
      MangayomiBackupTrackCopyWith<$R, MangayomiBackupTrack,
          MangayomiBackupTrack>>? get tracks;
  ListCopyWith<
      $R,
      MangayomiBackupHistory,
      MangayomiBackupHistoryCopyWith<$R, MangayomiBackupHistory,
          MangayomiBackupHistory>>? get history;
  ListCopyWith<
      $R,
      MangayomiBackupUpdate,
      MangayomiBackupUpdateCopyWith<$R, MangayomiBackupUpdate,
          MangayomiBackupUpdate>>? get updates;
  ListCopyWith<
      $R,
      MangayomiBackupSettings,
      MangayomiBackupSettingsCopyWith<$R, MangayomiBackupSettings,
          MangayomiBackupSettings>>? get settings;
  ListCopyWith<
      $R,
      ...
      MangayomiBackupExtensionPreferencesCopyWith<
          $R,
          MangayomiBackupExtensionPreferences,
          MangayomiBackupExtensionPreferences>>? get extensionPreferences;
  ListCopyWith<
      $R,
      ...
      MangayomiBackupTrackPreferencesCopyWith<
          $R,
          MangayomiBackupTrackPreferences,
          MangayomiBackupTrackPreferences>>? get trackPreferences;
  ListCopyWith<
      $R,
      MangayomiBackupExtension,
      MangayomiBackupExtensionCopyWith<$R, MangayomiBackupExtension,
          MangayomiBackupExtension>>? get extensions;
  $R call(
      {String? version,
...
class _MangayomiBackupDbCopyWithImpl<$R, $Out>
  ...
  ListCopyWith<
      ...
      MangayomiBackupManga,
      MangayomiBackupMangaCopyWith<$R, MangayomiBackupManga,
          MangayomiBackupManga>>? get manga => $value.manga != null
      ? ListCopyWith(
          $value.manga!, (v, t) => v.copyWith.$chain(t), (v) => call(manga: v))
      : null;
  @override
  ListCopyWith<
      $R,
      MangayomiBackupCategory,
      MangayomiBackupCategoryCopyWith<$R, MangayomiBackupCategory,
          MangayomiBackupCategory>>? get categories => $value.categories != null
  ...
  ListCopyWith<
      ...
      MangayomiBackupChapter,
      MangayomiBackupChapterCopyWith<$R, MangayomiBackupChapter,
          MangayomiBackupChapter>>? get chapters => $value.chapters != null
  ...
  ListCopyWith<
      ...
      MangayomiBackupDownload,
      MangayomiBackupDownloadCopyWith<$R, MangayomiBackupDownload,
          MangayomiBackupDownload>>? get downloads => $value.downloads != null
      ? ListCopyWith($value.downloads!, (v, t) => v.copyWith.$chain(t),
          (v) => call(downloads: v))
      : null;
  @override
  ListCopyWith<
      ...
      MangayomiBackupTrack,
      MangayomiBackupTrackCopyWith<$R, MangayomiBackupTrack,
          MangayomiBackupTrack>>? get tracks => $value.tracks != null
      ? ListCopyWith($value.tracks!, (v, t) => v.copyWith.$chain(t),
          (v) => call(tracks: v))
      : null;
  @override
  ListCopyWith<
      ...
      MangayomiBackupHistory,
      MangayomiBackupHistoryCopyWith<$R, MangayomiBackupHistory,
          MangayomiBackupHistory>>? get history => $value.history != null
  ...
  ListCopyWith<
      ...
      MangayomiBackupUpdate,
      MangayomiBackupUpdateCopyWith<$R, MangayomiBackupUpdate,
          MangayomiBackupUpdate>>? get updates => $value.updates != null
      ? ListCopyWith($value.updates!, (v, t) => v.copyWith.$chain(t),
          (v) => call(updates: v))
      : null;
  @override
  ListCopyWith<
      ...
      MangayomiBackupSettings,
      MangayomiBackupSettingsCopyWith<$R, MangayomiBackupSettings,
          MangayomiBackupSettings>>? get settings => $value.settings != null
      ? ListCopyWith($value.settings!, (v, t) => v.copyWith.$chain(t),
          (v) => call(settings: v))
      : null;
  @override
  ListCopyWith<
  ...
  ListCopyWith<
      ...
      $value.trackPreferences != null
          ? ListCopyWith($value.trackPreferences!,
              (v, t) => v.copyWith.$chain(t), (v) => call(trackPreferences: v))
          : null;
  @override
  ListCopyWith<
      $R,
      ...
      $value.extensions != null
          ? ListCopyWith($value.extensions!, (v, t) => v.copyWith.$chain(t),
              (v) => call(extensions: v))
          : null;
  @override
  $R call(
  ...
  MangayomiBackupDb $make(CopyWithData data) => MangayomiBackupDb(
      ...
      extensionPreferences:
          data.get(#extensionPreferences, or: $value.extensionPreferences),
      trackPreferences:
          data.get(#trackPreferences, or: $value.trackPreferences),
...
class MangayomiBackupMangaMapper extends ClassMapperBase<MangayomiBackupManga> {
  ...
  static const Field<MangayomiBackupManga, String> _f$source =
      Field('source', _$source);
  static String? _$author(MangayomiBackupManga v) => v.author;
  static const Field<MangayomiBackupManga, String> _f$author =
      Field('author', _$author);
  static String? _$artist(MangayomiBackupManga v) => v.artist;
  static const Field<MangayomiBackupManga, String> _f$artist =
      Field('artist', _$artist);
  static List<String>? _$genre(MangayomiBackupManga v) => v.genre;
  static const Field<MangayomiBackupManga, List<String>> _f$genre =
      Field('genre', _$genre);
  static String? _$imageUrl(MangayomiBackupManga v) => v.imageUrl;
  static const Field<MangayomiBackupManga, String> _f$imageUrl =
      Field('imageUrl', _$imageUrl);
  static String? _$lang(MangayomiBackupManga v) => v.lang;
  static const Field<MangayomiBackupManga, String> _f$lang =
      Field('lang', _$lang);
  static String? _$link(MangayomiBackupManga v) => v.link;
  static const Field<MangayomiBackupManga, String> _f$link =
      Field('link', _$link);
  static String? _$name(MangayomiBackupManga v) => v.name;
  static const Field<MangayomiBackupManga, String> _f$name =
      Field('name', _$name);
  static int? _$status(MangayomiBackupManga v) => v.status;
  static const Field<MangayomiBackupManga, int> _f$status =
      Field('status', _$status);
  static String? _$description(MangayomiBackupManga v) => v.description;
  static const Field<MangayomiBackupManga, String> _f$description =
      Field('description', _$description);
  static int? _$id(MangayomiBackupManga v) => v.id;
  static const Field<MangayomiBackupManga, int> _f$id =
      Field('id', _$id, opt: true);
  static bool? _$favorite(MangayomiBackupManga v) => v.favorite;
  static const Field<MangayomiBackupManga, bool> _f$favorite =
      Field('favorite', _$favorite, opt: true, def: false);
  static bool? _$isManga(MangayomiBackupManga v) => v.isManga;
  static const Field<MangayomiBackupManga, bool> _f$isManga =
      Field('isManga', _$isManga, opt: true);
  static ItemType? _$itemType(MangayomiBackupManga v) => v.itemType;
  static const Field<MangayomiBackupManga, ItemType> _f$itemType =
      Field('itemType', _$itemType, opt: true, def: ItemType.manga);
  static List<String>? _$genres(MangayomiBackupManga v) => v.genres;
  static const Field<MangayomiBackupManga, List<String>> _f$genres =
      Field('genres', _$genres, opt: true);
  static int? _$dateAdded(MangayomiBackupManga v) => v.dateAdded;
  static const Field<MangayomiBackupManga, int> _f$dateAdded =
      Field('dateAdded', _$dateAdded, opt: true);
  static int? _$lastUpdate(MangayomiBackupManga v) => v.lastUpdate;
  static const Field<MangayomiBackupManga, int> _f$lastUpdate =
      Field('lastUpdate', _$lastUpdate, opt: true);
  static String? _$categories(MangayomiBackupManga v) => v.categories;
  static const Field<MangayomiBackupManga, String> _f$categories =
      Field('categories', _$categories, opt: true);
  static int? _$lastRead(MangayomiBackupManga v) => v.lastRead;
  static const Field<MangayomiBackupManga, int> _f$lastRead =
      Field('lastRead', _$lastRead, opt: true, def: 0);
  static bool? _$isLocalArchive(MangayomiBackupManga v) => v.isLocalArchive;
  static const Field<MangayomiBackupManga, bool> _f$isLocalArchive =
      Field('isLocalArchive', _$isLocalArchive, opt: true, def: false);
  static String? _$customCoverImage(MangayomiBackupManga v) =>
      v.customCoverImage;
  static const Field<MangayomiBackupManga, String> _f$customCoverImage =
      Field('customCoverImage', _$customCoverImage, opt: true);
...
mixin MangayomiBackupMangaMappable {
  ...
  MangayomiBackupMangaCopyWith<MangayomiBackupManga, MangayomiBackupManga,
          MangayomiBackupManga>
  ...
  String toString() {
    return MangayomiBackupMangaMapper.ensureInitialized()
        .stringifyValue(this as MangayomiBackupManga);
  }

  @override
  bool operator ==(Object other) {
    return MangayomiBackupMangaMapper.ensureInitialized()
        .equalsValue(this as MangayomiBackupManga, other);
  }

  @override
  int get hashCode {
    return MangayomiBackupMangaMapper.ensureInitialized()
        .hashValue(this as MangayomiBackupManga);
  }
}
...
class _MangayomiBackupMangaCopyWithImpl<$R, $Out>
  ...
  ListCopyWith<$R, String, ObjectCopyWith<$R, String, String>>? get genre =>
      $value.genre != null
          ? ListCopyWith($value.genre!,
              (v, t) => ObjectCopyWith(v, $identity, t), (v) => call(genre: v))
          : null;
  @override
  ListCopyWith<$R, String, ObjectCopyWith<$R, String, String>>? get genres =>
      $value.genres != null
  ...
  MangayomiBackupManga $make(CopyWithData data) => MangayomiBackupManga(
      ...
      customCoverImage:
          data.get(#customCoverImage, or: $value.customCoverImage),
      customCoverFromTracker:
          data.get(#customCoverFromTracker, or: $value.customCoverFromTracker));
...
class MangayomiBackupCategoryMapper
  ...
  static MangayomiBackupCategoryMapper ensureInitialized() {
    if (_instance == null) {
      MapperContainer.globals
          .use(_instance = MangayomiBackupCategoryMapper._());
      MapperContainer.globals.useAll([SecondsEpochDateTimeMapper()]);
    }
    return _instance!;
  }
  ...
  static const Field<MangayomiBackupCategory, String> _f$name =
      Field('name', _$name);
  static int? _$forItemType(MangayomiBackupCategory v) => v.forItemType;
  static const Field<MangayomiBackupCategory, int> _f$forItemType =
      Field('forItemType', _$forItemType);
  static int? _$id(MangayomiBackupCategory v) => v.id;
  static const Field<MangayomiBackupCategory, int> _f$id =
      Field('id', _$id, opt: true);
  static int? _$pos(MangayomiBackupCategory v) => v.pos;
  static const Field<MangayomiBackupCategory, int> _f$pos =
      Field('pos', _$pos, opt: true);
  static bool? _$hide(MangayomiBackupCategory v) => v.hide;
  static const Field<MangayomiBackupCategory, bool> _f$hide =
...
mixin MangayomiBackupCategoryMappable {
  ...
  MangayomiBackupCategoryCopyWith<MangayomiBackupCategory,
          MangayomiBackupCategory, MangayomiBackupCategory>
      get copyWith => _MangayomiBackupCategoryCopyWithImpl(
          this as MangayomiBackupCategory, $identity, $identity);
  @override
  String toString() {
    return MangayomiBackupCategoryMapper.ensureInitialized()
        .stringifyValue(this as MangayomiBackupCategory);
  }

  @override
  bool operator ==(Object other) {
    return MangayomiBackupCategoryMapper.ensureInitialized()
        .equalsValue(this as MangayomiBackupCategory, other);
  }

  @override
  int get hashCode {
    return MangayomiBackupCategoryMapper.ensureInitialized()
        .hashValue(this as MangayomiBackupCategory);
  }
}
...
extension MangayomiBackupCategoryValueCopy<$R, $Out>
  ...
  MangayomiBackupCategoryCopyWith<$R, MangayomiBackupCategory, $Out>
      get $asMangayomiBackupCategory => $base
          .as((v, t, t2) => _MangayomiBackupCategoryCopyWithImpl(v, t, t2));
}
...
class MangayomiBackupChapterMapper
  ...
  static const Field<MangayomiBackupChapter, int> _f$mangaId =
      Field('mangaId', _$mangaId);
  static String? _$name(MangayomiBackupChapter v) => v.name;
  static const Field<MangayomiBackupChapter, String> _f$name =
      Field('name', _$name);
  static int? _$id(MangayomiBackupChapter v) => v.id;
  static const Field<MangayomiBackupChapter, int> _f$id =
      Field('id', _$id, opt: true);
  static String? _$url(MangayomiBackupChapter v) => v.url;
  static const Field<MangayomiBackupChapter, String> _f$url =
      Field('url', _$url, opt: true, def: '');
  static String? _$dateUpload(MangayomiBackupChapter v) => v.dateUpload;
  static const Field<MangayomiBackupChapter, String> _f$dateUpload =
      Field('dateUpload', _$dateUpload, opt: true, def: '');
  static bool? _$isBookmarked(MangayomiBackupChapter v) => v.isBookmarked;
  static const Field<MangayomiBackupChapter, bool> _f$isBookmarked =
      Field('isBookmarked', _$isBookmarked, opt: true, def: false);
  static String? _$scanlator(MangayomiBackupChapter v) => v.scanlator;
  static const Field<MangayomiBackupChapter, String> _f$scanlator =
      Field('scanlator', _$scanlator, opt: true, def: '');
  static bool? _$isRead(MangayomiBackupChapter v) => v.isRead;
  static const Field<MangayomiBackupChapter, bool> _f$isRead =
      Field('isRead', _$isRead, opt: true, def: false);
  static String? _$lastPageRead(MangayomiBackupChapter v) => v.lastPageRead;
  static const Field<MangayomiBackupChapter, String> _f$lastPageRead =
      Field('lastPageRead', _$lastPageRead, opt: true, def: '');
  static String? _$archivePath(MangayomiBackupChapter v) => v.archivePath;
  static const Field<MangayomiBackupChapter, String> _f$archivePath =
      Field('archivePath', _$archivePath, opt: true, def: '');
...
mixin MangayomiBackupChapterMappable {
  ...
  MangayomiBackupChapterCopyWith<MangayomiBackupChapter, MangayomiBackupChapter,
          MangayomiBackupChapter>
  ...
  String toString() {
    return MangayomiBackupChapterMapper.ensureInitialized()
        .stringifyValue(this as MangayomiBackupChapter);
  }

  @override
  bool operator ==(Object other) {
    return MangayomiBackupChapterMapper.ensureInitialized()
        .equalsValue(this as MangayomiBackupChapter, other);
  }

  @override
  int get hashCode {
    return MangayomiBackupChapterMapper.ensureInitialized()
        .hashValue(this as MangayomiBackupChapter);
  }
}
...
class MangayomiBackupDownloadMapper
  ...
  static MangayomiBackupDownloadMapper ensureInitialized() {
    if (_instance == null) {
      MapperContainer.globals
          .use(_instance = MangayomiBackupDownloadMapper._());
      MapperContainer.globals.useAll([SecondsEpochDateTimeMapper()]);
    }
    return _instance!;
  }
  ...
  static const Field<MangayomiBackupDownload, int> _f$succeeded =
      Field('succeeded', _$succeeded);
  static int? _$failed(MangayomiBackupDownload v) => v.failed;
  static const Field<MangayomiBackupDownload, int> _f$failed =
      Field('failed', _$failed);
  static int? _$total(MangayomiBackupDownload v) => v.total;
  static const Field<MangayomiBackupDownload, int> _f$total =
      Field('total', _$total);
  static bool? _$isDownload(MangayomiBackupDownload v) => v.isDownload;
  static const Field<MangayomiBackupDownload, bool> _f$isDownload =
      Field('isDownload', _$isDownload);
  static bool? _$isStartDownload(MangayomiBackupDownload v) =>
      v.isStartDownload;
  static const Field<MangayomiBackupDownload, bool> _f$isStartDownload =
      Field('isStartDownload', _$isStartDownload);
  static int? _$id(MangayomiBackupDownload v) => v.id;
  static const Field<MangayomiBackupDownload, int> _f$id =
...
mixin MangayomiBackupDownloadMappable {
  ...
  MangayomiBackupDownloadCopyWith<MangayomiBackupDownload,
          MangayomiBackupDownload, MangayomiBackupDownload>
      get copyWith => _MangayomiBackupDownloadCopyWithImpl(
          this as MangayomiBackupDownload, $identity, $identity);
  @override
  String toString() {
    return MangayomiBackupDownloadMapper.ensureInitialized()
        .stringifyValue(this as MangayomiBackupDownload);
  }

  @override
  bool operator ==(Object other) {
    return MangayomiBackupDownloadMapper.ensureInitialized()
        .equalsValue(this as MangayomiBackupDownload, other);
  }

  @override
  int get hashCode {
    return MangayomiBackupDownloadMapper.ensureInitialized()
        .hashValue(this as MangayomiBackupDownload);
  }
}
...
extension MangayomiBackupDownloadValueCopy<$R, $Out>
  ...
  MangayomiBackupDownloadCopyWith<$R, MangayomiBackupDownload, $Out>
      get $asMangayomiBackupDownload => $base
          .as((v, t, t2) => _MangayomiBackupDownloadCopyWithImpl(v, t, t2));
}
...
class MangayomiBackupTrackMapper extends ClassMapperBase<MangayomiBackupTrack> {
  ...
  static const Field<MangayomiBackupTrack, int> _f$status =
      Field('status', _$status);
  static int? _$id(MangayomiBackupTrack v) => v.id;
  static const Field<MangayomiBackupTrack, int> _f$id =
      Field('id', _$id, opt: true);
  static int? _$libraryId(MangayomiBackupTrack v) => v.libraryId;
  static const Field<MangayomiBackupTrack, int> _f$libraryId =
      Field('libraryId', _$libraryId, opt: true);
  static int? _$mediaId(MangayomiBackupTrack v) => v.mediaId;
  static const Field<MangayomiBackupTrack, int> _f$mediaId =
      Field('mediaId', _$mediaId, opt: true);
  static int? _$mangaId(MangayomiBackupTrack v) => v.mangaId;
  static const Field<MangayomiBackupTrack, int> _f$mangaId =
      Field('mangaId', _$mangaId, opt: true);
  static int? _$syncId(MangayomiBackupTrack v) => v.syncId;
  static const Field<MangayomiBackupTrack, int> _f$syncId =
      Field('syncId', _$syncId, opt: true);
  static String? _$title(MangayomiBackupTrack v) => v.title;
  static const Field<MangayomiBackupTrack, String> _f$title =
      Field('title', _$title, opt: true);
  static int? _$lastChapterRead(MangayomiBackupTrack v) => v.lastChapterRead;
  static const Field<MangayomiBackupTrack, int> _f$lastChapterRead =
      Field('lastChapterRead', _$lastChapterRead, opt: true);
  static int? _$totalChapter(MangayomiBackupTrack v) => v.totalChapter;
  static const Field<MangayomiBackupTrack, int> _f$totalChapter =
      Field('totalChapter', _$totalChapter, opt: true);
  static int? _$score(MangayomiBackupTrack v) => v.score;
  static const Field<MangayomiBackupTrack, int> _f$score =
      Field('score', _$score, opt: true);
  static int? _$startedReadingDate(MangayomiBackupTrack v) =>
      v.startedReadingDate;
  static const Field<MangayomiBackupTrack, int> _f$startedReadingDate =
      Field('startedReadingDate', _$startedReadingDate, opt: true);
  static int? _$finishedReadingDate(MangayomiBackupTrack v) =>
      v.finishedReadingDate;
  static const Field<MangayomiBackupTrack, int> _f$finishedReadingDate =
      Field('finishedReadingDate', _$finishedReadingDate, opt: true);
  static String? _$trackingUrl(MangayomiBackupTrack v) => v.trackingUrl;
  static const Field<MangayomiBackupTrack, String> _f$trackingUrl =
      Field('trackingUrl', _$trackingUrl, opt: true);
  static bool? _$isManga(MangayomiBackupTrack v) => v.isManga;
  static const Field<MangayomiBackupTrack, bool> _f$isManga =
      Field('isManga', _$isManga, opt: true);
  static ItemType _$itemType(MangayomiBackupTrack v) => v.itemType;
  static const Field<MangayomiBackupTrack, ItemType> _f$itemType =
      Field('itemType', _$itemType, opt: true, def: ItemType.manga);
...
mixin MangayomiBackupTrackMappable {
  ...
  MangayomiBackupTrackCopyWith<MangayomiBackupTrack, MangayomiBackupTrack,
          MangayomiBackupTrack>
  ...
  String toString() {
    return MangayomiBackupTrackMapper.ensureInitialized()
        .stringifyValue(this as MangayomiBackupTrack);
  }

  @override
  bool operator ==(Object other) {
    return MangayomiBackupTrackMapper.ensureInitialized()
        .equalsValue(this as MangayomiBackupTrack, other);
  }

  @override
  int get hashCode {
    return MangayomiBackupTrackMapper.ensureInitialized()
        .hashValue(this as MangayomiBackupTrack);
  }
}
...
class MangayomiBackupHistoryMapper
  ...
  static const Field<MangayomiBackupHistory, ItemType> _f$itemType =
      Field('itemType', _$itemType);
  static int? _$chapterId(MangayomiBackupHistory v) => v.chapterId;
  static const Field<MangayomiBackupHistory, int> _f$chapterId =
      Field('chapterId', _$chapterId);
  static int? _$mangaId(MangayomiBackupHistory v) => v.mangaId;
  static const Field<MangayomiBackupHistory, int> _f$mangaId =
      Field('mangaId', _$mangaId);
  static String? _$date(MangayomiBackupHistory v) => v.date;
  static const Field<MangayomiBackupHistory, String> _f$date =
      Field('date', _$date);
  static int? _$id(MangayomiBackupHistory v) => v.id;
  static const Field<MangayomiBackupHistory, int> _f$id =
      Field('id', _$id, opt: true);
  static bool? _$isManga(MangayomiBackupHistory v) => v.isManga;
  static const Field<MangayomiBackupHistory, bool> _f$isManga =
      Field('isManga', _$isManga, opt: true);
...
mixin MangayomiBackupHistoryMappable {
  ...
  MangayomiBackupHistoryCopyWith<MangayomiBackupHistory, MangayomiBackupHistory,
          MangayomiBackupHistory>
  ...
  String toString() {
    return MangayomiBackupHistoryMapper.ensureInitialized()
        .stringifyValue(this as MangayomiBackupHistory);
  }

  @override
  bool operator ==(Object other) {
    return MangayomiBackupHistoryMapper.ensureInitialized()
        .equalsValue(this as MangayomiBackupHistory, other);
  }

  @override
  int get hashCode {
    return MangayomiBackupHistoryMapper.ensureInitialized()
        .hashValue(this as MangayomiBackupHistory);
  }
}
...
class MangayomiBackupUpdateMapper
  ...
  static const Field<MangayomiBackupUpdate, int> _f$mangaId =
      Field('mangaId', _$mangaId);
  static String? _$chapterName(MangayomiBackupUpdate v) => v.chapterName;
  static const Field<MangayomiBackupUpdate, String> _f$chapterName =
      Field('chapterName', _$chapterName);
  static String? _$date(MangayomiBackupUpdate v) => v.date;
  static const Field<MangayomiBackupUpdate, String> _f$date =
      Field('date', _$date);
  static int? _$id(MangayomiBackupUpdate v) => v.id;
  static const Field<MangayomiBackupUpdate, int> _f$id =
      Field('id', _$id, opt: true);
...
mixin MangayomiBackupUpdateMappable {
  ...
  MangayomiBackupUpdateCopyWith<MangayomiBackupUpdate, MangayomiBackupUpdate,
          MangayomiBackupUpdate>
  ...
  String toString() {
    return MangayomiBackupUpdateMapper.ensureInitialized()
        .stringifyValue(this as MangayomiBackupUpdate);
  }

  @override
  bool operator ==(Object other) {
    return MangayomiBackupUpdateMapper.ensureInitialized()
        .equalsValue(this as MangayomiBackupUpdate, other);
  }

  @override
  int get hashCode {
    return MangayomiBackupUpdateMapper.ensureInitialized()
        .hashValue(this as MangayomiBackupUpdate);
  }
}
...
class MangayomiBackupExtensionPreferencesMapper
  ...
  static MangayomiBackupExtensionPreferencesMapper ensureInitialized() {
    if (_instance == null) {
      MapperContainer.globals
          .use(_instance = MangayomiBackupExtensionPreferencesMapper._());
      MapperContainer.globals.useAll([SecondsEpochDateTimeMapper()]);
  ...
  static const Field<MangayomiBackupExtensionPreferences, int> _f$id =
      Field('id', _$id, opt: true);
  ...
  static const Field<MangayomiBackupExtensionPreferences, EditTextPreference>
      _f$editTextPreference =
      Field('editTextPreference', _$editTextPreference, opt: true);
  ...
  static const Field<MangayomiBackupExtensionPreferences,
          SwitchPreferenceCompat> _f$switchPreferenceCompat =
      Field('switchPreferenceCompat', _$switchPreferenceCompat, opt: true);
  ...
  static const Field<MangayomiBackupExtensionPreferences,
      ...
      Field('multiSelectListPreference', _$multiSelectListPreference,
          opt: true);
  ...
  static MangayomiBackupExtensionPreferences fromMap(Map<String, dynamic> map) {
    return ensureInitialized()
        .decodeMap<MangayomiBackupExtensionPreferences>(map);
  }

  static MangayomiBackupExtensionPreferences fromJson(String json) {
    return ensureInitialized()
        .decodeJson<MangayomiBackupExtensionPreferences>(json);
  }
}
...
extension MangayomiBackupExtensionPreferencesValueCopy<$R, $Out>
  ...
  MangayomiBackupExtensionPreferencesCopyWith<$R,
          MangayomiBackupExtensionPreferences, $Out>
      get $asMangayomiBackupExtensionPreferences => $base.as((v, t, t2) =>
          _MangayomiBackupExtensionPreferencesCopyWithImpl(v, t, t2));
}
...
abstract class MangayomiBackupExtensionPreferencesCopyWith<
  ...
  ListPreferenceCopyWith<$R, ListPreference, ListPreference>?
      get listPreference;
  SwitchPreferenceCompatCopyWith<$R, SwitchPreferenceCompat,
      SwitchPreferenceCompat>? get switchPreferenceCompat;
  MultiSelectListPreferenceCopyWith<$R, MultiSelectListPreference,
...
class _MangayomiBackupExtensionPreferencesCopyWithImpl<$R, $Out>
  ...
  @override
  EditTextPreferenceCopyWith<$R, EditTextPreference, EditTextPreference>?
      get editTextPreference => $value.editTextPreference?.copyWith
          .$chain((v) => call(editTextPreference: v));
  @override
  ListPreferenceCopyWith<$R, ListPreference, ListPreference>?
      get listPreference => $value.listPreference?.copyWith
          .$chain((v) => call(listPreference: v));
  @override
  SwitchPreferenceCompatCopyWith<$R, SwitchPreferenceCompat,
          SwitchPreferenceCompat>?
      get switchPreferenceCompat => $value.switchPreferenceCompat?.copyWith
          .$chain((v) => call(switchPreferenceCompat: v));
  @override
  MultiSelectListPreferenceCopyWith<$R, MultiSelectListPreference,
          MultiSelectListPreference>?
      get multiSelectListPreference =>
          $value.multiSelectListPreference?.copyWith
  ...
  MangayomiBackupExtensionPreferences $make(CopyWithData data) =>
      MangayomiBackupExtensionPreferences(
          ...
          editTextPreference:
              data.get(#editTextPreference, or: $value.editTextPreference),
          listPreference: data.get(#listPreference, or: $value.listPreference),
          switchPreferenceCompat: data.get(#switchPreferenceCompat,
              or: $value.switchPreferenceCompat),
          multiSelectListPreference: data.get(#multiSelectListPreference,
              or: $value.multiSelectListPreference));

  @override
  MangayomiBackupExtensionPreferencesCopyWith<$R2,
      MangayomiBackupExtensionPreferences, $Out2> $chain<$R2, $Out2>(
          Then<$Out2, $R2> t) =>
...
class EditTextPreferenceMapper extends ClassMapperBase<EditTextPreference> {
  ...
  static const Field<EditTextPreference, String> _f$title =
      Field('title', _$title, opt: true);
  static String? _$summary(EditTextPreference v) => v.summary;
  static const Field<EditTextPreference, String> _f$summary =
      Field('summary', _$summary, opt: true);
  static String? _$value(EditTextPreference v) => v.value;
  static const Field<EditTextPreference, String> _f$value =
      Field('value', _$value, opt: true);
  static String? _$dialogTitle(EditTextPreference v) => v.dialogTitle;
  static const Field<EditTextPreference, String> _f$dialogTitle =
      Field('dialogTitle', _$dialogTitle, opt: true);
  static String? _$dialogMessage(EditTextPreference v) => v.dialogMessage;
  static const Field<EditTextPreference, String> _f$dialogMessage =
      Field('dialogMessage', _$dialogMessage, opt: true);
  static String? _$text(EditTextPreference v) => v.text;
  static const Field<EditTextPreference, String> _f$text =
...
mixin EditTextPreferenceMappable {
  ...
  EditTextPreferenceCopyWith<EditTextPreference, EditTextPreference,
          EditTextPreference>
      get copyWith => _EditTextPreferenceCopyWithImpl(
          this as EditTextPreference, $identity, $identity);
  @override
  String toString() {
    return EditTextPreferenceMapper.ensureInitialized()
        .stringifyValue(this as EditTextPreference);
  }

  @override
  bool operator ==(Object other) {
    return EditTextPreferenceMapper.ensureInitialized()
        .equalsValue(this as EditTextPreference, other);
  }

  @override
  int get hashCode {
    return EditTextPreferenceMapper.ensureInitialized()
        .hashValue(this as EditTextPreference);
  }
}
...
abstract class EditTextPreferenceCopyWith<$R, $In extends EditTextPreference,
    $Out> implements ClassCopyWith<$R, $In, $Out> {
  $R call(
      {String? title,
      String? summary,
...
class ListPreferenceMapper extends ClassMapperBase<ListPreference> {
  ...
  static const Field<ListPreference, String> _f$title =
      Field('title', _$title, opt: true);
  static String? _$summary(ListPreference v) => v.summary;
  static const Field<ListPreference, String> _f$summary =
      Field('summary', _$summary, opt: true);
  static int? _$valueIndex(ListPreference v) => v.valueIndex;
  static const Field<ListPreference, int> _f$valueIndex =
      Field('valueIndex', _$valueIndex, opt: true);
  static List<String>? _$entries(ListPreference v) => v.entries;
  static const Field<ListPreference, List<String>> _f$entries =
      Field('entries', _$entries, opt: true);
  static List<String>? _$entryValues(ListPreference v) => v.entryValues;
  static const Field<ListPreference, List<String>> _f$entryValues =
...
mixin ListPreferenceMappable {
  String toJson() {
    return ListPreferenceMapper.ensureInitialized()
        .encodeJson<ListPreference>(this as ListPreference);
  }

  Map<String, dynamic> toMap() {
    return ListPreferenceMapper.ensureInitialized()
        .encodeMap<ListPreference>(this as ListPreference);
  }

  ListPreferenceCopyWith<ListPreference, ListPreference, ListPreference>
      get copyWith => _ListPreferenceCopyWithImpl(
          this as ListPreference, $identity, $identity);
  @override
  String toString() {
    return ListPreferenceMapper.ensureInitialized()
        .stringifyValue(this as ListPreference);
  }

  @override
  bool operator ==(Object other) {
    return ListPreferenceMapper.ensureInitialized()
        .equalsValue(this as ListPreference, other);
  }

  @override
  int get hashCode {
    return ListPreferenceMapper.ensureInitialized()
        .hashValue(this as ListPreference);
  }
}
...
class SwitchPreferenceCompatMapper
  ...
  static const Field<SwitchPreferenceCompat, String> _f$title =
      Field('title', _$title, opt: true);
  static String? _$summary(SwitchPreferenceCompat v) => v.summary;
  static const Field<SwitchPreferenceCompat, String> _f$summary =
      Field('summary', _$summary, opt: true);
  static bool? _$value(SwitchPreferenceCompat v) => v.value;
  static const Field<SwitchPreferenceCompat, bool> _f$value =
      Field('value', _$value, opt: true);
...
mixin SwitchPreferenceCompatMappable {
  ...
  SwitchPreferenceCompatCopyWith<SwitchPreferenceCompat, SwitchPreferenceCompat,
          SwitchPreferenceCompat>
  ...
  String toString() {
    return SwitchPreferenceCompatMapper.ensureInitialized()
        .stringifyValue(this as SwitchPreferenceCompat);
  }

  @override
  bool operator ==(Object other) {
    return SwitchPreferenceCompatMapper.ensureInitialized()
        .equalsValue(this as SwitchPreferenceCompat, other);
  }

  @override
  int get hashCode {
    return SwitchPreferenceCompatMapper.ensureInitialized()
        .hashValue(this as SwitchPreferenceCompat);
  }
}
...
class MultiSelectListPreferenceMapper
  ...
  static MultiSelectListPreferenceMapper ensureInitialized() {
    if (_instance == null) {
      MapperContainer.globals
          .use(_instance = MultiSelectListPreferenceMapper._());
      MapperContainer.globals.useAll([SecondsEpochDateTimeMapper()]);
    }
    return _instance!;
  }
  ...
  static const Field<MultiSelectListPreference, String> _f$title =
      Field('title', _$title, opt: true);
  static String? _$summary(MultiSelectListPreference v) => v.summary;
  static const Field<MultiSelectListPreference, String> _f$summary =
      Field('summary', _$summary, opt: true);
  static List<String>? _$values(MultiSelectListPreference v) => v.values;
  static const Field<MultiSelectListPreference, List<String>> _f$values =
...
mixin MultiSelectListPreferenceMappable {
  ...
  MultiSelectListPreferenceCopyWith<MultiSelectListPreference,
          MultiSelectListPreference, MultiSelectListPreference>
  ...
  String toString() {
    return MultiSelectListPreferenceMapper.ensureInitialized()
        .stringifyValue(this as MultiSelectListPreference);
  }

  @override
  bool operator ==(Object other) {
    return MultiSelectListPreferenceMapper.ensureInitialized()
        .equalsValue(this as MultiSelectListPreference, other);
  }

  @override
  int get hashCode {
    return MultiSelectListPreferenceMapper.ensureInitialized()
        .hashValue(this as MultiSelectListPreference);
  }
}
...
extension MultiSelectListPreferenceValueCopy<$R, $Out>
  ...
  MultiSelectListPreferenceCopyWith<$R, MultiSelectListPreference, $Out>
      get $asMultiSelectListPreference => $base
          .as((v, t, t2) => _MultiSelectListPreferenceCopyWithImpl(v, t, t2));
}
...
class MangayomiBackupTrackPreferencesMapper
  ...
  static MangayomiBackupTrackPreferencesMapper ensureInitialized() {
    if (_instance == null) {
      MapperContainer.globals
          .use(_instance = MangayomiBackupTrackPreferencesMapper._());
      MapperContainer.globals.useAll([SecondsEpochDateTimeMapper()]);
    }
    return _instance!;
  }
  ...
  static const Field<MangayomiBackupTrackPreferences, int> _f$chapterId =
      Field('chapterId', _$chapterId, opt: true);
  static int? _$date(MangayomiBackupTrackPreferences v) => v.date;
  static const Field<MangayomiBackupTrackPreferences, int> _f$date =
      Field('date', _$date, opt: true);
  static int? _$id(MangayomiBackupTrackPreferences v) => v.id;
  static const Field<MangayomiBackupTrackPreferences, int> _f$id =
      Field('id', _$id, opt: true);
  static int? _$itemType(MangayomiBackupTrackPreferences v) => v.itemType;
  static const Field<MangayomiBackupTrackPreferences, int> _f$itemType =
      Field('itemType', _$itemType, opt: true);
  static int? _$mangaId(MangayomiBackupTrackPreferences v) => v.mangaId;
  static const Field<MangayomiBackupTrackPreferences, int> _f$mangaId =
      Field('mangaId', _$mangaId, opt: true);
  ...
  static MangayomiBackupTrackPreferences fromJson(String json) {
    return ensureInitialized()
        .decodeJson<MangayomiBackupTrackPreferences>(json);
  }
}
...
mixin MangayomiBackupTrackPreferencesMappable {
  ...
  MangayomiBackupTrackPreferencesCopyWith<MangayomiBackupTrackPreferences,
          MangayomiBackupTrackPreferences, MangayomiBackupTrackPreferences>
  ...
  int get hashCode {
    return MangayomiBackupTrackPreferencesMapper.ensureInitialized()
        .hashValue(this as MangayomiBackupTrackPreferences);
  }
}

extension MangayomiBackupTrackPreferencesValueCopy<$R, $Out>
    on ObjectCopyWith<$R, MangayomiBackupTrackPreferences, $Out> {
  MangayomiBackupTrackPreferencesCopyWith<$R, MangayomiBackupTrackPreferences,
          $Out>
...
class _MangayomiBackupTrackPreferencesCopyWithImpl<$R, $Out>
    ...
    implements
        MangayomiBackupTrackPreferencesCopyWith<$R,
            MangayomiBackupTrackPreferences, $Out> {
  ...
  @override
  MangayomiBackupTrackPreferencesCopyWith<$R2, MangayomiBackupTrackPreferences,
      $Out2> $chain<$R2, $Out2>(
          Then<$Out2, $R2> t) =>
...
class MangayomiBackupExtensionMapper
  ...
  static MangayomiBackupExtensionMapper ensureInitialized() {
    if (_instance == null) {
      MapperContainer.globals
          .use(_instance = MangayomiBackupExtensionMapper._());
      MapperContainer.globals.useAll([SecondsEpochDateTimeMapper()]);
      ItemTypeMapper.ensureInitialized();
  ...
  static const Field<MangayomiBackupExtension, int> _f$id =
      Field('id', _$id, opt: true, def: 0);
  static String? _$name(MangayomiBackupExtension v) => v.name;
  static const Field<MangayomiBackupExtension, String> _f$name =
      Field('name', _$name, opt: true, def: '');
  static String? _$baseUrl(MangayomiBackupExtension v) => v.baseUrl;
  static const Field<MangayomiBackupExtension, String> _f$baseUrl =
      Field('baseUrl', _$baseUrl, opt: true, def: '');
  static String? _$lang(MangayomiBackupExtension v) => v.lang;
  static const Field<MangayomiBackupExtension, String> _f$lang =
      Field('lang', _$lang, opt: true, def: '');
  static String? _$typeSource(MangayomiBackupExtension v) => v.typeSource;
  static const Field<MangayomiBackupExtension, String> _f$typeSource =
      Field('typeSource', _$typeSource, opt: true, def: '');
  static String? _$iconUrl(MangayomiBackupExtension v) => v.iconUrl;
  static const Field<MangayomiBackupExtension, String> _f$iconUrl =
      Field('iconUrl', _$iconUrl, opt: true, def: '');
  static String? _$dateFormat(MangayomiBackupExtension v) => v.dateFormat;
  static const Field<MangayomiBackupExtension, String> _f$dateFormat =
      Field('dateFormat', _$dateFormat, opt: true, def: '');
  ...
  static const Field<MangayomiBackupExtension, bool> _f$isActive =
      Field('isActive', _$isActive, opt: true, def: true);
  static bool? _$isAdded(MangayomiBackupExtension v) => v.isAdded;
  static const Field<MangayomiBackupExtension, bool> _f$isAdded =
      Field('isAdded', _$isAdded, opt: true, def: false);
  static bool? _$isNsfw(MangayomiBackupExtension v) => v.isNsfw;
  static const Field<MangayomiBackupExtension, bool> _f$isNsfw =
      Field('isNsfw', _$isNsfw, opt: true, def: false);
  static bool? _$isFullData(MangayomiBackupExtension v) => v.isFullData;
  static const Field<MangayomiBackupExtension, bool> _f$isFullData =
      Field('isFullData', _$isFullData, opt: true, def: false);
  static bool? _$hasCloudflare(MangayomiBackupExtension v) => v.hasCloudflare;
  static const Field<MangayomiBackupExtension, bool> _f$hasCloudflare =
      Field('hasCloudflare', _$hasCloudflare, opt: true, def: false);
  static bool? _$isPinned(MangayomiBackupExtension v) => v.isPinned;
  static const Field<MangayomiBackupExtension, bool> _f$isPinned =
      Field('isPinned', _$isPinned, opt: true, def: false);
  static bool? _$lastUsed(MangayomiBackupExtension v) => v.lastUsed;
  static const Field<MangayomiBackupExtension, bool> _f$lastUsed =
      Field('lastUsed', _$lastUsed, opt: true, def: false);
  static String? _$apiUrl(MangayomiBackupExtension v) => v.apiUrl;
  static const Field<MangayomiBackupExtension, String> _f$apiUrl =
      Field('apiUrl', _$apiUrl, opt: true, def: '');
  static String? _$sourceCodeUrl(MangayomiBackupExtension v) => v.sourceCodeUrl;
  static const Field<MangayomiBackupExtension, String> _f$sourceCodeUrl =
      Field('sourceCodeUrl', _$sourceCodeUrl, opt: true, def: '');
  static String? _$version(MangayomiBackupExtension v) => v.version;
  static const Field<MangayomiBackupExtension, String> _f$version =
      Field('version', _$version, opt: true, def: '0.0.1');
  static String? _$versionLast(MangayomiBackupExtension v) => v.versionLast;
  static const Field<MangayomiBackupExtension, String> _f$versionLast =
      Field('versionLast', _$versionLast, opt: true, def: '0.0.1');
  static String? _$sourceCode(MangayomiBackupExtension v) => v.sourceCode;
  static const Field<MangayomiBackupExtension, String> _f$sourceCode =
      Field('sourceCode', _$sourceCode, opt: true, def: '');
  static String? _$headers(MangayomiBackupExtension v) => v.headers;
  static const Field<MangayomiBackupExtension, String> _f$headers =
      Field('headers', _$headers, opt: true, def: '');
  static bool? _$isManga(MangayomiBackupExtension v) => v.isManga;
  static const Field<MangayomiBackupExtension, bool> _f$isManga =
      Field('isManga', _$isManga, opt: true);
  static ItemType _$itemType(MangayomiBackupExtension v) => v.itemType;
  static const Field<MangayomiBackupExtension, ItemType> _f$itemType =
      Field('itemType', _$itemType, opt: true, def: ItemType.manga);
  static String? _$appMinVerReq(MangayomiBackupExtension v) => v.appMinVerReq;
  static const Field<MangayomiBackupExtension, String> _f$appMinVerReq =
      Field('appMinVerReq', _$appMinVerReq, opt: true, def: '');
  ...
  static const Field<MangayomiBackupExtension, bool> _f$isLocal =
      Field('isLocal', _$isLocal, opt: true, def: false);
  static bool? _$isObsolete(MangayomiBackupExtension v) => v.isObsolete;
  static const Field<MangayomiBackupExtension, bool> _f$isObsolete =
      Field('isObsolete', _$isObsolete, opt: true, def: false);
  static Repo? _$repo(MangayomiBackupExtension v) => v.repo;
  static const Field<MangayomiBackupExtension, Repo> _f$repo =
      Field('repo', _$repo, opt: true);
  ...
  static const Field<MangayomiBackupExtension, SourceCodeLanguage>
      _f$sourceCodeLanguage = Field('sourceCodeLanguage', _$sourceCodeLanguage,
          opt: true, def: SourceCodeLanguage.dart);
...
mixin MangayomiBackupExtensionMappable {
  ...
  MangayomiBackupExtensionCopyWith<MangayomiBackupExtension,
          MangayomiBackupExtension, MangayomiBackupExtension>
      get copyWith => _MangayomiBackupExtensionCopyWithImpl(
          this as MangayomiBackupExtension, $identity, $identity);
  @override
  String toString() {
    return MangayomiBackupExtensionMapper.ensureInitialized()
        .stringifyValue(this as MangayomiBackupExtension);
  }

  @override
  bool operator ==(Object other) {
    return MangayomiBackupExtensionMapper.ensureInitialized()
        .equalsValue(this as MangayomiBackupExtension, other);
  }

  @override
  int get hashCode {
    return MangayomiBackupExtensionMapper.ensureInitialized()
        .hashValue(this as MangayomiBackupExtension);
  }
}
...
extension MangayomiBackupExtensionValueCopy<$R, $Out>
  ...
  MangayomiBackupExtensionCopyWith<$R, MangayomiBackupExtension, $Out>
      get $asMangayomiBackupExtension => $base
          .as((v, t, t2) => _MangayomiBackupExtensionCopyWithImpl(v, t, t2));
}
...
class _MangayomiBackupExtensionCopyWithImpl<$R, $Out>
  ...
  MangayomiBackupExtension $make(CopyWithData data) => MangayomiBackupExtension(
      ...
      dateFormatLocale:
          data.get(#dateFormatLocale, or: $value.dateFormatLocale),
      ...
      additionalParams:
          data.get(#additionalParams, or: $value.additionalParams),
      ...
      sourceCodeLanguage:
          data.get(#sourceCodeLanguage, or: $value.sourceCodeLanguage));
