...
mixin TachiBackupChapterMappable {
  ...
  >
  get copyWith =>
      _TachiBackupChapterCopyWithImpl<TachiBackupChapter, TachiBackupChapter>(
...
extension TachiBackupChapterValueCopy<$R, $Out>
  ...
  get $asTachiBackupChapter => $base.as(
    (v, t, t2) => _TachiBackupChapterCopyWithImpl<$R, $Out>(v, t, t2),
  );
}
...
class _TachiBackupChapterCopyWithImpl<$R, $Out>
  ...
  TachiBackupChapterCopyWith<$R2, TachiBackupChapter, $Out2> $chain<$R2, $Out2>(
    Then<$Out2, $R2> t,
  ) => _TachiBackupChapterCopyWithImpl<$R2, $Out2>($value, $cast, t);
}
