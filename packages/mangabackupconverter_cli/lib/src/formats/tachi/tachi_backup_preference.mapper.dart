...
class TachiBackupPreferenceMapper
  ...
  static const Field<TachiBackupPreference, String> _f$key = Field(
    'key',
    _$key,
  );
...
mixin TachiBackupPreferenceMappable {
  ...
  >
  get copyWith =>
      _TachiBackupPreferenceCopyWithImpl<
        TachiBackupPreference,
        TachiBackupPreference
      >(this as TachiBackupPreference, $identity, $identity);
  @override
  String toString() {
    return TachiBackupPreferenceMapper.ensureInitialized().stringifyValue(
  ...
  bool operator ==(Object other) {
    return TachiBackupPreferenceMapper.ensureInitialized().equalsValue(
      this as TachiBackupPreference,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return TachiBackupPreferenceMapper.ensureInitialized().hashValue(
      this as TachiBackupPreference,
    );
  }
}
...
extension TachiBackupPreferenceValueCopy<$R, $Out>
  ...
  get $asTachiBackupPreference => $base.as(
    (v, t, t2) => _TachiBackupPreferenceCopyWithImpl<$R, $Out>(v, t, t2),
  );
}
...
>
  ...
  TachiBackupPreferenceValueCopyWith<
    $R,
...
class _TachiBackupPreferenceCopyWithImpl<$R, $Out>
  ...
  @override
  $R call({String? key, TachiBackupPreferenceValue? value}) => $apply(
    FieldCopyWithData({
      if (key != null) #key: key,
  ...
  $chain<$R2, $Out2>(Then<$Out2, $R2> t) =>
      _TachiBackupPreferenceCopyWithImpl<$R2, $Out2>($value, $cast, t);
}
...
class TachiBackupPreferenceValueMapper
  ...
  static TachiBackupPreferenceValueMapper ensureInitialized() {
    if (_instance == null) {
      MapperContainer.globals.use(
        _instance = TachiBackupPreferenceValueMapper._(),
      );
    }
    return _instance!;
  }
  ...
  static const Field<TachiBackupPreferenceValue, String> _f$type = Field(
    'type',
    _$type,
  );
  ...
  static TachiBackupPreferenceValue _instantiate(DecodingData data) {
    return TachiBackupPreferenceValue(
      ...
      truevalue: data.dec(_f$truevalue),
    );
  }
...
mixin TachiBackupPreferenceValueMappable {
  ...
  >
  get copyWith =>
      _TachiBackupPreferenceValueCopyWithImpl<
        TachiBackupPreferenceValue,
        TachiBackupPreferenceValue
      >(this as TachiBackupPreferenceValue, $identity, $identity);
  @override
  String toString() {
    return TachiBackupPreferenceValueMapper.ensureInitialized().stringifyValue(
      this as TachiBackupPreferenceValue,
    );
  }
  ...
  @override
  bool operator ==(Object other) {
    return TachiBackupPreferenceValueMapper.ensureInitialized().equalsValue(
      this as TachiBackupPreferenceValue,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return TachiBackupPreferenceValueMapper.ensureInitialized().hashValue(
      this as TachiBackupPreferenceValue,
    );
  }
}
...
extension TachiBackupPreferenceValueValueCopy<$R, $Out>
  ...
  get $asTachiBackupPreferenceValue => $base.as(
    (v, t, t2) => _TachiBackupPreferenceValueCopyWithImpl<$R, $Out>(v, t, t2),
  );
}
...
class _TachiBackupPreferenceValueCopyWithImpl<$R, $Out>
  ...
  @override
  $R call({String? type, List<int>? truevalue}) => $apply(
    FieldCopyWithData({
  ...
  $chain<$R2, $Out2>(Then<$Out2, $R2> t) =>
      _TachiBackupPreferenceValueCopyWithImpl<$R2, $Out2>($value, $cast, t);
}
