...
class _TachiBackupPreferenceCopyWithImpl<$R, $Out>
  ...
  @override
  TachiBackupPreferenceCopyWith<$R2, TachiBackupPreference, $Out2> $chain<
    $R2,
    $Out2
  >(Then<$Out2, $R2> t) => _TachiBackupPreferenceCopyWithImpl($value, $cast, t);
}
...
extension TachiBackupPreferenceValueValueCopy<$R, $Out>
  ...
  get $asTachiBackupPreferenceValue =>
