...
class NekoBackupMergeMangaMapper extends ClassMapperBase<NekoBackupMergeManga> {
  ...
  static const Field<NekoBackupMergeManga, String> _f$title = Field('title', _$title);
  static String _$coverUrl(NekoBackupMergeManga v) => v.coverUrl;
  static const Field<NekoBackupMergeManga, String> _f$coverUrl = Field('coverUrl', _$coverUrl);
  static int _$mergeType(NekoBackupMergeManga v) => v.mergeType;
  static const Field<NekoBackupMergeManga, int> _f$mergeType = Field('mergeType', _$mergeType);
...
mixin NekoBackupMergeMangaMappable {
  String toJson() {
    return NekoBackupMergeMangaMapper.ensureInitialized().encodeJson<NekoBackupMergeManga>(
      this as NekoBackupMergeManga,
    );
  }

  Map<String, dynamic> toMap() {
    return NekoBackupMergeMangaMapper.ensureInitialized().encodeMap<NekoBackupMergeManga>(this as NekoBackupMergeManga);
  }

  NekoBackupMergeMangaCopyWith<NekoBackupMergeManga, NekoBackupMergeManga, NekoBackupMergeManga> get copyWith =>
      _NekoBackupMergeMangaCopyWithImpl(this as NekoBackupMergeManga, $identity, $identity);
  @override
  String toString() {
    return NekoBackupMergeMangaMapper.ensureInitialized().stringifyValue(this as NekoBackupMergeManga);
  }

  @override
  bool operator ==(Object other) {
    return NekoBackupMergeMangaMapper.ensureInitialized().equalsValue(this as NekoBackupMergeManga, other);
  }

  @override
  int get hashCode {
    return NekoBackupMergeMangaMapper.ensureInitialized().hashValue(this as NekoBackupMergeManga);
  }
}

extension NekoBackupMergeMangaValueCopy<$R, $Out> on ObjectCopyWith<$R, NekoBackupMergeManga, $Out> {
  NekoBackupMergeMangaCopyWith<$R, NekoBackupMergeManga, $Out> get $asNekoBackupMergeManga =>
      $base.as((v, t, t2) => _NekoBackupMergeMangaCopyWithImpl(v, t, t2));
}

abstract class NekoBackupMergeMangaCopyWith<$R, $In extends NekoBackupMergeManga, $Out>
    implements ClassCopyWith<$R, $In, $Out> {
  $R call({String? url, String? title, String? coverUrl, int? mergeType});
  NekoBackupMergeMangaCopyWith<$R2, $In, $Out2> $chain<$R2, $Out2>(Then<$Out2, $R2> t);
}

class _NekoBackupMergeMangaCopyWithImpl<$R, $Out> extends ClassCopyWithBase<$R, NekoBackupMergeManga, $Out>
  ...
  @override
  late final ClassMapperBase<NekoBackupMergeManga> $mapper = NekoBackupMergeMangaMapper.ensureInitialized();
  @override
  $R call({String? url, String? title, String? coverUrl, int? mergeType}) => $apply(
    FieldCopyWithData({
      if (url != null) #url: url,
  ...
  @override
  NekoBackupMergeMangaCopyWith<$R2, NekoBackupMergeManga, $Out2> $chain<$R2, $Out2>(Then<$Out2, $R2> t) =>
