...
class NekoBackupMergeMangaMapper extends ClassMapperBase<NekoBackupMergeManga> {
  ...
  static const Field<NekoBackupMergeManga, String> _f$title = Field(
    'title',
    _$title,
  );
  static String _$coverUrl(NekoBackupMergeManga v) => v.coverUrl;
  static const Field<NekoBackupMergeManga, String> _f$coverUrl = Field(
    'coverUrl',
    _$coverUrl,
  );
  static int _$mergeType(NekoBackupMergeManga v) => v.mergeType;
  static const Field<NekoBackupMergeManga, int> _f$mergeType = Field(
    'mergeType',
    _$mergeType,
  );
...
mixin NekoBackupMergeMangaMappable {
  ...
  NekoBackupMergeMangaCopyWith<
    NekoBackupMergeManga,
    NekoBackupMergeManga,
    NekoBackupMergeManga
  >
  get copyWith =>
      _NekoBackupMergeMangaCopyWithImpl<
        NekoBackupMergeManga,
        NekoBackupMergeManga
      >(this as NekoBackupMergeManga, $identity, $identity);
  @override
  String toString() {
    return NekoBackupMergeMangaMapper.ensureInitialized().stringifyValue(
  ...
  bool operator ==(Object other) {
    return NekoBackupMergeMangaMapper.ensureInitialized().equalsValue(
      this as NekoBackupMergeManga,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return NekoBackupMergeMangaMapper.ensureInitialized().hashValue(
      this as NekoBackupMergeManga,
    );
  }
}
...
extension NekoBackupMergeMangaValueCopy<$R, $Out>
  ...
  get $asNekoBackupMergeManga => $base.as(
    (v, t, t2) => _NekoBackupMergeMangaCopyWithImpl<$R, $Out>(v, t, t2),
  );
}
...
class _NekoBackupMergeMangaCopyWithImpl<$R, $Out>
  ...
  $chain<$R2, $Out2>(Then<$Out2, $R2> t) =>
      _NekoBackupMergeMangaCopyWithImpl<$R2, $Out2>($value, $cast, t);
}
