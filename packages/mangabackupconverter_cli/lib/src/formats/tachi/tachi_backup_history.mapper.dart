...
mixin TachiBackupHistoryMappable {
  ...
  >
  get copyWith =>
      _TachiBackupHistoryCopyWithImpl<TachiBackupHistory, TachiBackupHistory>(
...
extension TachiBackupHistoryValueCopy<$R, $Out>
  ...
  get $asTachiBackupHistory => $base.as(
    (v, t, t2) => _TachiBackupHistoryCopyWithImpl<$R, $Out>(v, t, t2),
  );
}
...
class _TachiBackupHistoryCopyWithImpl<$R, $Out>
  ...
  TachiBackupHistoryCopyWith<$R2, TachiBackupHistory, $Out2> $chain<$R2, $Out2>(
    Then<$Out2, $R2> t,
  ) => _TachiBackupHistoryCopyWithImpl<$R2, $Out2>($value, $cast, t);
}
...
mixin TachiBrokenBackupHistoryMappable {
  ...
  >
  get copyWith =>
      _TachiBrokenBackupHistoryCopyWithImpl<
        TachiBrokenBackupHistory,
        TachiBrokenBackupHistory
...
extension TachiBrokenBackupHistoryValueCopy<$R, $Out>
  ...
  get $asTachiBrokenBackupHistory => $base.as(
    (v, t, t2) => _TachiBrokenBackupHistoryCopyWithImpl<$R, $Out>(v, t, t2),
  );
}
...
class _TachiBrokenBackupHistoryCopyWithImpl<$R, $Out>
  ...
  $chain<$R2, $Out2>(Then<$Out2, $R2> t) =>
      _TachiBrokenBackupHistoryCopyWithImpl<$R2, $Out2>($value, $cast, t);
}
