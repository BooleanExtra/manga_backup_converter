...
mixin AidokuBackupHistoryMappable {
  ...
  >
  get copyWith =>
      _AidokuBackupHistoryCopyWithImpl<
        AidokuBackupHistory,
        AidokuBackupHistory
...
extension AidokuBackupHistoryValueCopy<$R, $Out>
  ...
  get $asAidokuBackupHistory => $base.as(
    (v, t, t2) => _AidokuBackupHistoryCopyWithImpl<$R, $Out>(v, t, t2),
  );
}
...
class _AidokuBackupHistoryCopyWithImpl<$R, $Out>
  ...
  $chain<$R2, $Out2>(Then<$Out2, $R2> t) =>
      _AidokuBackupHistoryCopyWithImpl<$R2, $Out2>($value, $cast, t);
}
