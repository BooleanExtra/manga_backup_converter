...
class AidokuBackupLibraryMangaMapper
  ...
  static const Field<AidokuBackupLibraryManga, DateTime> _f$lastOpened = Field(
    'lastOpened',
    _$lastOpened,
  );
  static DateTime _$lastUpdated(AidokuBackupLibraryManga v) => v.lastUpdated;
  static const Field<AidokuBackupLibraryManga, DateTime> _f$lastUpdated = Field(
    'lastUpdated',
    _$lastUpdated,
  );
  static DateTime? _$lastRead(AidokuBackupLibraryManga v) => v.lastRead;
  static const Field<AidokuBackupLibraryManga, DateTime> _f$lastRead = Field(
    'lastRead',
    _$lastRead,
  );
  static DateTime _$dateAdded(AidokuBackupLibraryManga v) => v.dateAdded;
  static const Field<AidokuBackupLibraryManga, DateTime> _f$dateAdded = Field(
    'dateAdded',
    _$dateAdded,
  );
  ...
  static const Field<AidokuBackupLibraryManga, String> _f$mangaId = Field(
    'mangaId',
    _$mangaId,
  );
  static String _$sourceId(AidokuBackupLibraryManga v) => v.sourceId;
  static const Field<AidokuBackupLibraryManga, String> _f$sourceId = Field(
    'sourceId',
    _$sourceId,
  );
...
mixin AidokuBackupLibraryMangaMappable {
  ...
  AidokuBackupLibraryMangaCopyWith<
    AidokuBackupLibraryManga,
    AidokuBackupLibraryManga,
    AidokuBackupLibraryManga
  >
  get copyWith =>
      _AidokuBackupLibraryMangaCopyWithImpl<
        AidokuBackupLibraryManga,
        AidokuBackupLibraryManga
      >(this as AidokuBackupLibraryManga, $identity, $identity);
  @override
  String toString() {
    return AidokuBackupLibraryMangaMapper.ensureInitialized().stringifyValue(
  ...
  bool operator ==(Object other) {
    return AidokuBackupLibraryMangaMapper.ensureInitialized().equalsValue(
      this as AidokuBackupLibraryManga,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return AidokuBackupLibraryMangaMapper.ensureInitialized().hashValue(
      this as AidokuBackupLibraryManga,
    );
  }
}
...
extension AidokuBackupLibraryMangaValueCopy<$R, $Out>
  ...
  get $asAidokuBackupLibraryManga => $base.as(
    (v, t, t2) => _AidokuBackupLibraryMangaCopyWithImpl<$R, $Out>(v, t, t2),
  );
}
...
class _AidokuBackupLibraryMangaCopyWithImpl<$R, $Out>
  ...
  $chain<$R2, $Out2>(Then<$Out2, $R2> t) =>
      _AidokuBackupLibraryMangaCopyWithImpl<$R2, $Out2>($value, $cast, t);
}
