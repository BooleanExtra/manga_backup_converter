...
class AidokuBackupChapterMapper extends ClassMapperBase<AidokuBackupChapter> {
  ...
  static const Field<AidokuBackupChapter, String> _f$sourceId = Field('sourceId', _$sourceId);
  static String _$mangaId(AidokuBackupChapter v) => v.mangaId;
  static const Field<AidokuBackupChapter, String> _f$mangaId = Field('mangaId', _$mangaId);
  ...
  static const Field<AidokuBackupChapter, String> _f$title = Field('title', _$title);
  static String? _$scanlator(AidokuBackupChapter v) => v.scanlator;
  static const Field<AidokuBackupChapter, String> _f$scanlator = Field('scanlator', _$scanlator);
  static String _$lang(AidokuBackupChapter v) => v.lang;
  static const Field<AidokuBackupChapter, String> _f$lang = Field('lang', _$lang);
  static double? _$chapter(AidokuBackupChapter v) => v.chapter;
  static const Field<AidokuBackupChapter, double> _f$chapter = Field('chapter', _$chapter);
  static double? _$volume(AidokuBackupChapter v) => v.volume;
  static const Field<AidokuBackupChapter, double> _f$volume = Field('volume', _$volume);
  static DateTime? _$dateUploaded(AidokuBackupChapter v) => v.dateUploaded;
  static const Field<AidokuBackupChapter, DateTime> _f$dateUploaded = Field('dateUploaded', _$dateUploaded);
  static int _$sourceOrder(AidokuBackupChapter v) => v.sourceOrder;
  static const Field<AidokuBackupChapter, int> _f$sourceOrder = Field('sourceOrder', _$sourceOrder);
...
mixin AidokuBackupChapterMappable {
  String toJson() {
    return AidokuBackupChapterMapper.ensureInitialized().encodeJson<AidokuBackupChapter>(this as AidokuBackupChapter);
  }

  Map<String, dynamic> toMap() {
    return AidokuBackupChapterMapper.ensureInitialized().encodeMap<AidokuBackupChapter>(this as AidokuBackupChapter);
  }

  AidokuBackupChapterCopyWith<AidokuBackupChapter, AidokuBackupChapter, AidokuBackupChapter> get copyWith =>
      _AidokuBackupChapterCopyWithImpl(this as AidokuBackupChapter, $identity, $identity);
  @override
  String toString() {
    return AidokuBackupChapterMapper.ensureInitialized().stringifyValue(this as AidokuBackupChapter);
  }

  @override
  bool operator ==(Object other) {
    return AidokuBackupChapterMapper.ensureInitialized().equalsValue(this as AidokuBackupChapter, other);
  }

  @override
  int get hashCode {
    return AidokuBackupChapterMapper.ensureInitialized().hashValue(this as AidokuBackupChapter);
  }
}

extension AidokuBackupChapterValueCopy<$R, $Out> on ObjectCopyWith<$R, AidokuBackupChapter, $Out> {
  AidokuBackupChapterCopyWith<$R, AidokuBackupChapter, $Out> get $asAidokuBackupChapter =>
      $base.as((v, t, t2) => _AidokuBackupChapterCopyWithImpl(v, t, t2));
}

abstract class AidokuBackupChapterCopyWith<$R, $In extends AidokuBackupChapter, $Out>
  ...
  AidokuBackupChapterCopyWith<$R2, $In, $Out2> $chain<$R2, $Out2>(Then<$Out2, $R2> t);
}

class _AidokuBackupChapterCopyWithImpl<$R, $Out> extends ClassCopyWithBase<$R, AidokuBackupChapter, $Out>
  ...
  @override
  late final ClassMapperBase<AidokuBackupChapter> $mapper = AidokuBackupChapterMapper.ensureInitialized();
  @override
  $R call({
    String? sourceId,
    String? mangaId,
  ...
  @override
  AidokuBackupChapterCopyWith<$R2, AidokuBackupChapter, $Out2> $chain<$R2, $Out2>(Then<$Out2, $R2> t) =>
