...
mixin AidokuBackupTrackItemMappable {
  ...
  >
  get copyWith =>
      _AidokuBackupTrackItemCopyWithImpl<
        AidokuBackupTrackItem,
        AidokuBackupTrackItem
...
extension AidokuBackupTrackItemValueCopy<$R, $Out>
  ...
  get $asAidokuBackupTrackItem => $base.as(
    (v, t, t2) => _AidokuBackupTrackItemCopyWithImpl<$R, $Out>(v, t, t2),
  );
}
...
class _AidokuBackupTrackItemCopyWithImpl<$R, $Out>
  ...
  $chain<$R2, $Out2>(Then<$Out2, $R2> t) =>
      _AidokuBackupTrackItemCopyWithImpl<$R2, $Out2>($value, $cast, t);
}
