...
//
// Run: dart test packages/aidoku_plugin_loader/test/wasm/async_sleep_test.dart --reporter expanded
import 'dart:async';
import 'dart:isolate';
...
void main() {
  group('asyncSleep semaphore round-trip', skip: true, () {
    test('blocks isolate for ~1 second', () async {
      ...
      final result = await stream.firstWhere((Object? msg) => msg is _SleepResult) as _SleepResult;
      resultPort.close();
      semaphore.dispose();
