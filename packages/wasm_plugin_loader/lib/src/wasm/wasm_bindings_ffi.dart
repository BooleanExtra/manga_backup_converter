...
class WasmerBindings {
  ...
  late final _functypeResults = _lib.lookupFunction<
      ffi.Pointer<_WasmValtypeVecT> Function(ffi.Pointer<WasmFunctypeT>),
      ffi.Pointer<_WasmValtypeVecT> Function(ffi.Pointer<WasmFunctypeT>)>(
    'wasm_functype_results',
  );
  late final _valtypeKind = _lib.lookupFunction<
      ffi.Uint8 Function(ffi.Pointer<ffi.Opaque>),
      int Function(ffi.Pointer<ffi.Opaque>)>('wasm_valtype_kind');
