...
class WasmerBindings {
  ...
  late final ffi.Pointer<_WasmValtypeVecT> Function(ffi.Pointer<WasmFunctypeT>) _functypeResults = _lib
      .lookupFunction<
  ...
  late final int Function(ffi.Pointer<ffi.Opaque>) _valtypeKind = _lib
  ...
  int functypeFirstResultKind(ffi.Pointer<WasmFunctypeT> functype) {
    final ffi.Pointer<_WasmValtypeVecT> vec = _functypeResults(functype);
